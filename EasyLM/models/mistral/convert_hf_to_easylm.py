...
def main(args):
    ...
    # iteratrate all weight and if their type is bfloat16, convert it to float32
    ...
    if args.streaming:
        StreamingCheckpointer.save_train_state_to_file(jax_weights, args.output_file, float_dtype='bfloat16')
    else:

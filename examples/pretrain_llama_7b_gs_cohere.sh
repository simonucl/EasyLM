...
python -m EasyLM.models.llama.llama_train \
    ...
    --train_dataset.selection_indices_path='gs://data-selection-bucket/data/selection/indices/cohere_Random_0.05_Llama-2-7b-hf.pkl' \
    --train_dataset.json_torch_dataset.path='gs://data-selection-bucket/data/processed/cohere/cohere_data.jsonl' \

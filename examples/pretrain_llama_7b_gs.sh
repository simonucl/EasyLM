...
python -m EasyLM.models.llama.llama_train \
    ...
    --train_dataset.json_processed_dataset.path='gs://data-selection-bucket/data/processed/sharegpt/sharegpt_data_processed.jsonl' \
    --train_dataset.json_processed_dataset.seq_length=4096 \
    --train_dataset.json_processed_dataset.batch_size=4 \
    --train_dataset.json_processed_dataset.num_workers=24 \
